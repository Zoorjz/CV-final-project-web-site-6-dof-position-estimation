...
**Generation Timestamp**: `20260913_191915`  
**Output Directory**: `C:\OneDrive_1trb\OneDrive\UTN Studies\CV\Final Proj\web-site\data\renders\geometry-based\renders_20260913_191914`  
...
| :--- | :--- | :--- | :--- | :--- |
| `01_dark_raw.mp4` | 1000 µs (Dark IR) | Raw Footage (No Overlay) | 83.34 s | 3000 frames |
| `02_dark_gt.mp4` | 1000 µs (Dark IR) | VR Ground Truth 3D Pose (Magenta/Yellow Axes & Trail) + 3D Trajectory Trails | 83.34 s | 3000 frames |
| `03_dark_filtration.mp4` | 1000 µs (Dark IR) | Filtered Stream (Isolated LEDs, No Markers) | 83.34 s | 3000 frames |
| `04_dark_filtration_gt.mp4` | 1000 µs (Dark IR) | Filtered Stream (No Markers) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
| `05_dark_blobs.mp4` | 1000 µs (Dark IR) | Filtered Stream Backdrop + 2D Detected Blobs (Cyan Candidates & Red PnP) | 83.34 s | 3000 frames |
| `06_dark_blobs_gt.mp4` | 1000 µs (Dark IR) | Filtered Stream Backdrop + 2D Detected Blobs (Cyan Candidates & Red PnP) + VR Ground Truth 3D Pose (Magenta/Yellow Axes & Trail) + 3D Trajectory Trails | 83.34 s | 3000 frames |
| `07_dark_pnp.mp4` | 1000 µs (Dark IR) | Filtered Stream Backdrop + Raw PnP 3D Pose (RGB Axes & Active Red Markers) + 3D Trajectory Trails | 83.34 s | 3000 frames |
| `08_dark_pnp_gt.mp4` | 1000 µs (Dark IR) | Filtered Stream Backdrop + Raw PnP 3D Pose (RGB Axes & Active Red Markers) + VR Ground Truth 3D Pose (Magenta/Yellow Axes & Trail) + 3D Trajectory Trails | 83.34 s | 3000 frames |
| `09_dark_ekf.mp4` | 1000 µs (Dark IR) | Filtered Stream Backdrop + EKF Smoothed 3D Pose (RGB Axes & Aqua Trail) + 3D Trajectory Trails | 83.34 s | 3000 frames |
| `10_dark_ekf_gt.mp4` | 1000 µs (Dark IR) | Filtered Stream Backdrop + EKF Smoothed 3D Pose (RGB Axes & Aqua Trail) + VR Ground Truth 3D Pose (Magenta/Yellow Axes & Trail) + 3D Trajectory Trails | 83.34 s | 3000 frames |
| `11_bright_raw.mp4` | 10000 µs (Bright Visual) | Raw Footage (No Overlay) | 83.34 s | 3000 frames |
| `12_bright_gt.mp4` | 10000 µs (Bright Visual) | VR Ground Truth 3D Pose (Magenta/Yellow Axes & Trail) + 3D Trajectory Trails | 83.34 s | 3000 frames |
