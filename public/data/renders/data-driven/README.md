...
**Generation Timestamp**: `20260913_192150`  
**Pipeline Mode**: `ALL`  
**Output Directory**: `C:\OneDrive_1trb\OneDrive\UTN Studies\CV\Final Proj\web-site\data\renders\data-driven\renders_20260913_191914`  
...
| :--- | :--- | :--- | :--- | :--- |
| `01_bright_raw.mp4` | 10000 µs (Bright Visual) | Raw Footage (No Overlay) | 83.34 s | 3000 frames |
| `02_bright_gt.mp4` | 10000 µs (Bright Visual) | VR Ground Truth 3D Pose (Bright Green/Yellow/Orange Axes & Trail) | 83.34 s | 3000 frames |
| `03_dark_raw.mp4` | 1000 µs (Dark IR) | Raw Footage (No Overlay) | 83.34 s | 3000 frames |
| `04_dark_gt.mp4` | 1000 µs (Dark IR) | VR Ground Truth 3D Pose (Bright Green/Yellow/Orange Axes & Trail) | 83.34 s | 3000 frames |
| `05_cnn_raw.mp4` | 1000 µs (Dark IR) | Dark Video + Raw CNN Direct 6-DoF Pose (Orchid Axes & Violet Trail) | 83.34 s | 3000 frames |
| `06_cnn_gt.mp4` | 1000 µs (Dark IR) | Dark Video + Raw CNN Direct 6-DoF Pose (Orchid Axes & Violet Trail) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
| `07_cnn_kf_raw.mp4` | 1000 µs (Dark IR) | Dark Video + Kalman Filtered CNN 6-DoF Pose (Deep Violet Axes & Indigo Trail) | 83.34 s | 3000 frames |
| `08_cnn_kf_gt.mp4` | 1000 µs (Dark IR) | Dark Video + Kalman Filtered CNN 6-DoF Pose (Deep Violet Axes & Indigo Trail) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
| `05_dark_filtration.mp4` | 1000 µs (Dark IR) | Filtered Stream (Isolated LEDs, No Markers) | 83.34 s | 3000 frames |
| `06_dark_filtration_gt.mp4` | 1000 µs (Dark IR) | Filtered Stream (No Markers) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
| `07_dark_blobs.mp4` | 1000 µs (Dark IR) | Filtered Stream + 2D Detected Blobs (Cyan Candidates & Red Tracking) | 83.34 s | 3000 frames |
| `08_dark_blobs_gt.mp4` | 1000 µs (Dark IR) | Filtered Stream + 2D Detected Blobs (Cyan Candidates & Red Tracking) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
| `09_ml_raw.mp4` | 1000 µs (Dark IR) | Filtered Backdrop + Raw ML Feature Regressor 6-DoF Pose (Coral Axes & Amber Trail) | 83.34 s | 3000 frames |
| `10_ml_gt.mp4` | 1000 µs (Dark IR) | Filtered Backdrop + Raw ML Feature Regressor 6-DoF Pose (Coral Axes & Amber Trail) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
| `11_ml_kf_raw.mp4` | 1000 µs (Dark IR) | Filtered Backdrop + Kalman Filtered ML 6-DoF Pose (Tangerine Axes & Canary Gold Trail) | 83.34 s | 3000 frames |
| `12_ml_kf_gt.mp4` | 1000 µs (Dark IR) | Filtered Backdrop + Kalman Filtered ML 6-DoF Pose (Tangerine Axes & Canary Gold Trail) + VR Ground Truth 3D Pose | 83.34 s | 3000 frames |
